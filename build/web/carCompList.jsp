...
<html>
    ...
    <%
        ...
        List<Car> carAll = cDao.retrieveAllCar(compid);
    ...
    <body>
        ...
        <div id="body">
            ...
            <center><a href="addCar.jsp"><input style="font-size: 25px" type="button" id="btnSubmit" value="Add Car Ads"/></a></center><br/>
            <table style="background-color: #ffe8df; width: 1000px" align="center">
                ...
                <td style="width: 170px"><center><a href=carStatus.jsp?id="<%=carAll.get(i).getFlatno()%>">Car Status</a></center>
