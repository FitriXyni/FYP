...
<html lang="en">
    ...
    <body>
        ...
        <div id="body">
            ...
            <h1 class="titleRent">Welcome Company <%=company.getCompname() %>.</h1>
            ...
            <center><form action="processLC.jsp" method="post">
                    <fieldset style="background-color: #ffffff; width: 400px; height:310px">
                        ...
                        <a href=carCompList.jsp?id="<%=company.getCompid()%>"><input style="font-size: 25px" type="button" id="btnSubmit" value="Add Car Rent"/></a>
