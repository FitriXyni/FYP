...
<html lang="en">
    ...
    <body>
        ...
        <div id="body">
            ...
            <center><form action="addCar" method="post" enctype="multipart/form-data">
                    <fieldset style="background-color: #ffffff; width: 400px; height:620px">
                        <legend><h1><b style="color:rgb(255, 166, 0);">Add Car Form</b></h1></legend>
                        <center><input style="margin-top: 1em;" type="file" name="photo" size="50" onchange="readURL(this)"/></center><br>
                        <img style="margin-left: 3.1em;" id="blah" src="http://placehold.it/180" alt="your image" /><br/><br/>
                        <label>Flat Number: </label>
                        <input type="text" name="noPlat" placeholder="No Spacing" size="50"/><br/><br/>
                        <label>Price Per Hour (RM) : </label>
                        <input type="text" name="price" size="50"/><br/><br/>
                        <label>Company Contact : </label>
                        <input type="text" name="contact" value="<%=company.getCompcontact() %>" size="50" disabled=""/><br/><br/>
                        <select type="text" name="carname" required>
                            <option selected disable=''>Car Name</option>
                        ...
                        <select type="text" name="cartype" required>
                        ...
                        <input type="hidden" name="cid" value="<%=company.getCompid() %>" size="50"/>
                        <input type="hidden" name="status" value="Available"/>
                        <input type="hidden" name="contact" value="<%=company.getCompcontact() %>" size="50"/>
                        <input type="submit" id="btnSubmit" value="Register"/><br/><br/>
                        <a style="font-size: 19px; color: white;" href=carCompList.jsp?id="<%=company.getCompid() %>">[Back]</a>
