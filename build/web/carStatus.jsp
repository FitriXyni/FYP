    ...
    <body>
        <nav class="headerNav">
            <ul>
                ...
                <li id="navDropdownMenu"><a href=carCompList.jsp?id="<%=company.getCompid() %>">Back</a></li>
        ...
        <div id="body">
            ...
            <center><form action="updateCarStatus.jsp" method="post">
                    <fieldset style="background-color: #ffffff; width: 400px; height:640px">
                        <legend><h1><b style="color:rgb(255, 166, 0);">Update Status Form</b></h1></legend>
                        ...
                        <label for="Not Available">Not Available</label></td></center><br/>
                        <input type="hidden" value="<%=car.getFlatno() %>" name="flatno"/>
