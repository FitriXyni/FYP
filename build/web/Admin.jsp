...
<html lang="en">
    ...
    <body>
        ...
        <div id="body">
            ...
            <h1 class="titleRent">Perform with Honest</h1>

            <center><form action="processLA.jsp" method="post">
                    <fieldset style="background-color: #ffffff; width: 400px; height:310px">
                        ...
                        <a href="registerAdmin.jsp"><input type="button" id="btnSubmit" value="Sign In"/></a>
