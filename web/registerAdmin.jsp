...
<html lang="en">
    ...
    <body>
        ...
        <div id="body">
            ...
            <center><form action="processRA.jsp" method="post">
                    <fieldset style="background-color: #ffffff; width: 400px; height:325px">
                        <legend><h1><b style="color:rgb(255, 166, 0);">Registration Form</b></h1></legend>
                        <label>Admin Id </label>
                        <input type="text" name="aid" size="50"/><br/><br/>
                        <label>Password: </label>
                        <input type="password" name="apassword" size="50"/><br/><br/>
                        <label>Admin Name : </label>
                        <input type="text" name="aname" size="50"/><br/><br/>
                        <label>Admin Contact : </label>
                        <input type="text" name="acontact" size="50"/><br/><br/>

                        <input type="submit" id="btnSubmit" value="Register"/><br/><br/>
                        <a style="font-size: 19px; color: white;" href="Admin.jsp">[Back]</a>
