...
<body>
    <div class="body">
     <center>
        <p class="sign"><%=request.getAttribute("Message")%></p>
    </center>
    <center><a style="font-size: 17px; color: white;" href=carCompList.jsp?id="<%=company.getCompid() %>">[Back]</a></center>
    </div>
    <div class="bg-image bg-image-home" />
</body>
</html>
