...
<html lang="en">
    ...
    <body>
        ...
        <div id="body">
            ...
            <h1 class="titleRent">Welcome Company <%=admin.getAname() %>.</h1>

            <center><form action="processLC.jsp" method="post">
                    <fieldset style="background-color: #ffffff; width: 400px; height:310px">
                        <legend><h1><b style="color:rgb(255, 166, 0);">Company Module</b></h1></legend>
                        
                        <a href="listAds.jsp"><input style="font-size: 25px" type="button" id="btnSubmit" value="Manage Advertisement"/></a><br/><br/>
                        <a href="listFeedback.jsp"><input style="font-size: 25px" type="button" id="btnSubmit" value="List Feedback"/></a>
