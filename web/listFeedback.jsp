...
<%@page import="carrental.Admin, carrental.DBConnection, carrental.adminDAO"%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <%
        ...
        List<Admin> feedback = adminDAO.retrieveFeedback();
    ...
    <body>
        ...
        <nav class="headerNav">
            <ul>
                ...
                <li><a href="modulAdmin.jsp">Back</a></li>
        ...
        <div id="body">
            ...
            <br/>
            <center><h2 style="color: white">Your Feedback Information</h2></center>
            ...
            <table style="background-color: #ffe8df; width: 1000px" align="center">
                ...
                <td><center><%=feedback.get(i).getFeedid()%></center></td>
                <td><center><%=feedback.get(i).getAfeedback()%></center></td>
